...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bhash.conf'
CONFIGFOLDER='/root/.bhash'
COIN_DAEMON='/usr/local/bin/bhashd'
COIN_CLI='/usr/local/bin/bhash-cli'
COIN_REPO='https://github.com/bhashcoin/bhash/releases/download/v2.0.4.2/bhash-2.0.4.2-linux.tar.gz'
COIN_NAME='bhash'
COIN_PORT=17652
RPC_PORT=17652
...
function compile_node() {
  ...
  compile_error
  cp usr/local/bin/bhash* /usr/local/bin
  compile_error
