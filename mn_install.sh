...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='mangaka.conf'
CONFIGFOLDER='/root/.mangaka'
COIN_DAEMON='/usr/local/bin/mangakad'
COIN_CLI='/usr/local/bin/mangaka-cli'
COIN_REPO='https://github.com/mangakacoin/Mangaka-Core/releases/download/v.10.0.0.4/Ubuntu.16.x.tar.gz'
COIN_NAME='Mangaka'
COIN_PORT=9711
RPC_PORT=9880
...
function compile_node() {
  ...
  compile_error
  cp usr/local/bin/checkсash* /usr/local/bin
  compile_error
